...
- [ ] Kontakte & Profile: Anzeigename + Avatar, E2E-verschlüsselt geteilt (Signal-Profile-Keys; Server sieht nur Ciphertext, analog #25). Vom denker zerlegt. **Alle 4 Sub-Punkte code-komplett + Cloud-verifiziert (tsc 0, Tests, Build grün); Server-Teil ist bereits live. USER: einmal auf Render deployen, dann abhaken.**
